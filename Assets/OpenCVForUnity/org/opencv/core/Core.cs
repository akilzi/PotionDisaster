 ...
 */
	public static Size getTextSize(string text, int fontFace, double fontScale, int thickness, int[] baseLine) {
		...
		// C++:  void gemm(Mat src1, Mat src2, double alpha, Mat src3, double gamma, Mat& dst, int flags = 0)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_gemm_10(IntPtr src1_nativeObj, IntPtr src2_nativeObj, double alpha, IntPtr src3_nativeObj, double gamma, IntPtr dst_nativeObj, int flags);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_gemm_11(IntPtr src1_nativeObj, IntPtr src2_nativeObj, double alpha, IntPtr src3_nativeObj, double gamma, IntPtr dst_nativeObj);
