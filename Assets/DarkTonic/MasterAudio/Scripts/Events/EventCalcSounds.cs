		...
		switch (soundSpawnMode) {
			case MasterAudio.SoundSpawnLocationMode.CallerLocation:
                if (aEvent.emitParticles) {
                    ...
                    MasterAudio.PlaySound3DAtTransformAndForget(sType, this.trans, volume, pitch);
                }
				break;
			case MasterAudio.SoundSpawnLocationMode.AttachToCaller:
                if (aEvent.emitParticles) {
                    ...
                    MasterAudio.PlaySound3DFollowTransformAndForget(sType, this.trans, volume, pitch);
                }
				break;
